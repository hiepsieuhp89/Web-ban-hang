								...
								<div class="col-sm-4" style="margin-top:20px;">
									<div class="single-item">
										...
										<div class="single-item-caption">
											<a class="add-to-cart pull-left" href="{{route('AddToCart',$params = ['id' => $sp->id,'qty' => '1'])}}"><i class="fa fa-shopping-cart"></i></a>
  						...
  						<div class="row">
								...
								<div class="col-sm-4">
									<div class="single-item">
										...
										<div class="single-item-caption">
											<a class="add-to-cart pull-left" href="{{route('AddToCart',$params = ['id' => $other->id,'qty' => '1'])}}"><i class="fa fa-shopping-cart"></i></a>
