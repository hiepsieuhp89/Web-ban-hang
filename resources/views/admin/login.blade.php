...
<!--===============================================================================================-->
    <link rel="stylesheet" type="text/css" href="source/assets/vendor/bootstrap/css/bootstrap.min.css">
<!--===============================================================================================-->
...
<body>
    ...
    <div class="limiter">
        <div class="container-login100" style="background-image: url('source/image/1.jpg'); min-height: 100vh;">
            <div class="wrap-login100 p-l-110 p-r-110 p-t-62 p-b-33" style="opacity: 0.7; width: 30vw; padding: 20px; background-color: #ea8167;">
                <form class="login100-form validate-form flex-sb flex-w" action="" method="post">
                    {{ csrf_field() }}
                    <span class="login100-form-title p-b-53" style="margin-top: 20px; color: white;">
                        ADMIN
                    </span>
                    ...
                    <div class="container-login100-form-btn m-t-17" style="margin-top: 50px;">
...
<!--===============================================================================================-->
    <script src="source/assets/vendor/jquery/jquery-3.2.1.min.js"></script>
<!--===============================================================================================-->
...
<!--===============================================================================================-->
    ...
    <script src="source/assets/vendor/bootstrap/js/bootstrap.min.js"></script>
<!--===============================================================================================-->
