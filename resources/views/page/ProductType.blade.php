...
<body class="archive tax-product_cat term-cham-soc-da-mat term-17 woocommerce woocommerce-page woocommerce-no-js header-shadow lightbox lazy-icons nav-dropdown-has-arrow">
   ...
   <div class="shop-page-title category-page-title page-title ">
      <div class="page-title-inner flex-row  medium-flex-wrap container">
         <div class="flex-col flex-grow medium-text-center">
            ...
            <div class="is-small">
               <nav class="woocommerce-breadcrumb breadcrumbs"><a style="text-decoration: none;"href="{{route('HomePage')}}">Trang chủ</a> <span class="divider">&#47;<a style="text-decoration: none;"href="{{route('ProductType','dtdd')}}"></span>Điện thoại thông minh</a></nav>
            </div>
   ...
   <!--<input type="checkbox" id="woof_36_5e8ab1a8a2ac5" class="woof_checkbox_term woof_checkbox_term_36" data-tax="pwb-brand" name="brand" data-term-id="36" value="{{$key->name}}"  style="margin-left: 20px;">-->
   <?php 
   		$url =  url()->full();
